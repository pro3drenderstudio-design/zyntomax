...
export const metadata: Metadata = {
  title: "Get the Zyntomax Vendor app",
...
const FEATURES = [
  { icon: "📸", title: "Request pickups", desc: "Snap a photo of your recyclables and we come to you." },
  { icon: "🚛", title: "Track your collector", desc: "See your collector on a live map as they head your way." },
  { icon: "💰", title: "Wallet & withdrawals", desc: "Watch your balance grow and cash out to your bank anytime." },
  { icon: "🏷️", title: "Live rates", desc: "Always know today's price per kg before you sell." },
  { icon: "🎁", title: "Rewards & referrals", desc: "Earn rewards as you recycle, and bonuses when you invite friends." },
  { icon: "🔒", title: "Secure", desc: "Fingerprint app-lock and bank-verified payments keep you safe." },
];

const STEPS = [
  "Tap “Download the app” to get the APK file.",
  "Open it. If your phone warns about “unknown sources”, tap Settings and allow installs from your browser, then continue.",
...
export default function DownloadPage() {
  ...
  const APK_URL = "/downloads/vendor";
  return (
    <main style={{ background: "#0b3d24", minHeight: "100vh", color: "#fff", fontFamily: "system-ui, -apple-system, Segoe UI, Roboto, sans-serif" }}>
      ...
      <section style={{ background: "linear-gradient(160deg,#008037 0%,#0b3d24 100%)", padding: "56px 20px 64px", textAlign: "center" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <h1 style={{ fontSize: 40, fontWeight: 800, letterSpacing: -1, margin: "0 0 8px" }}>Zyntomax Vendor</h1>
          <p style={{ fontSize: 20, opacity: 0.9, margin: "0 0 8px", fontWeight: 600 }}>Recycle. Earn. Get paid.</p>
          <p style={{ fontSize: 16, opacity: 0.85, maxWidth: 520, margin: "0 auto 28px" }}>
            Turn your recyclables into cash. Request a pickup in seconds, track your collector live, and withdraw your earnings straight to your bank.
          </p>
          {APK_URL ? (
          ...
          <p style={{ fontSize: 13, opacity: 0.7, marginTop: 14 }}>Android APK · Free · Play Store version coming soon</p>
        </div>
      </section>
      ...
      <section style={{ background: "#f4f7f5", color: "#0f172a", padding: "48px 20px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <h2 style={{ fontSize: 24, fontWeight: 800, textAlign: "center", marginBottom: 28 }}>Everything you need to recycle for cash</h2>
      ...
      <footer style={{ background: "#06331d", padding: "28px 20px", textAlign: "center", fontSize: 14, opacity: 0.85 }}>
        <p style={{ margin: "0 0 4px" }}>Need help? Call us on <a href={`tel:${SUPPORT_PHONE}`} style={{ color: "#7ed957", fontWeight: 700 }}>{SUPPORT_PHONE}</a></p>
        <p style={{ margin: 0, opacity: 0.7 }}>© Zyntomax Ventures Limited · Recycling Operations</p>
      </footer>
    </main>
  );
}
